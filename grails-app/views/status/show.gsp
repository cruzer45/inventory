	...
	<body>
		...
		<div id="show-status" class="content scaffold-show" role="main">
			...
			<ol class="property-list status">
				...
				<g:if test="${statusInstance?.deleted}">
				<li class="fieldcontain">
					<span id="deleted-label" class="property-label"><g:message code="status.deleted.label" default="Deleted" /></span>
					
						<span class="property-value" aria-labelledby="deleted-label"><g:formatBoolean boolean="${statusInstance?.deleted}" /></span>
